  ...
  return (
    <div className="relative">
      ...
      <div className="flex flex-col justify-center items-center ">
        <div className="z-30 relative flex flex-col justify-center items-center md:gap-6 gap-3 top-20  bg-slate-100 rounded-2xl p-4 md:p-10 max-sm:w-[95%] sm:w-[400px] ">
