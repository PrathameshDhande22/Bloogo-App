...
export const SearchPage = ({ searchParams }) => {
  ...
  return (
    <div className="space-y-4 pt-4">
      <div className="font-spec text-xl sm:text-4xl font-extrabold">
        Results for {searchParams.get("q").toString()}
      </div>
      <div className="space-y-2 font-lum font-semibold flex flex-col justify-center items-center">
        <span className="block w-full sm:w-3/4">Search By</span>
        <div className="w-full md:w-3/4 font-spec font-semibold flex flex-row items-center border-b-2 border-gray-100 tracking-wide">
          <NavLink
